...
::: {#lem-symmetric-list-objects-equivalent-to-sequential-colimit-construction}
If $\cat{C}$ is symmetric monoidal closed and has the relevant colimits, the following are equivalent:
